...
class CommandHandler {
	...
	constructor(bot) {
		...
		// 	console.log(`Text commands loaded for shard(s) ${bot.shard.ids.join(', ')}`)
		// })
	}
...
function registerSubcommands(command, module, name) {	
...
module.exports = { handler: CommandHandler, load };